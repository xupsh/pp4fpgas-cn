...
$$
$$
\forall i>1,\text{firstst\_codeword}(i) = (\text{first\_codeword}(i-1) + \text{codeword\_length\_histogram}(i-1))\ll1 \qquad(11.3)
$$
...
$$
$$
\text{first\_codeword}(2) = (0 + 0) \ll 1 \quad\,\,= 0b00 \ (11.5) \  
$$
$$
...
$$
$$  
\text{C}  \rightarrow \quad110   \qquad(11.6)  
$$
$$
